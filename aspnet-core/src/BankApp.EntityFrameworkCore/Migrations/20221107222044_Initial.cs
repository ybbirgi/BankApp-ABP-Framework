        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RiskLimit = table.Column<float>(type: "real", nullable: false, defaultValue: 10000f),
                    RemainingRiskLimit = table.Column<float>(type: "real", nullable: false, defaultValue: 10000f),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Debt = table.Column<float>(type: "real", nullable: false, defaultValue: 0f),
                    Status = table.Column<bool>(type: "boolean", nullable: false, defaultValue: true),
                    ExtraProperties = table.Column<string>(type: "text", nullable: true),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionDirection = table.Column<int>(type: "integer", nullable: false),
